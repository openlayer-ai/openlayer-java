...
import com.openlayer.api.errors.OpenlayerServiceException
...
class ErrorHandlingTest {
    ...
    private val OPENLAYER_ERROR: OpenlayerError = OpenlayerError.builder().putAdditionalProperty("key", JsonString.of("value")).build()

    private lateinit var client: OpenlayerClient

    @BeforeEach
    fun beforeEach(wmRuntimeInfo: WireMockRuntimeInfo) {
      client = OpenlayerOkHttpClient.builder()
    ...
    fun dataStream200() {
      ...
      val expected = InferencePipelineDataStreamResponse.builder()
    ...
    fun dataStream400() {
      ...
      assertThatThrownBy({ client.inferencePipelines().data().stream(params) })
          .satisfies({ e -> assertBadRequest(e, ImmutableListMultimap.of("Foo", "Bar"), OPENLAYER_ERROR) })
    }
    ...
    fun dataStream401() {
      ...
      assertThatThrownBy({ client.inferencePipelines().data().stream(params) })
          .satisfies({ e -> assertUnauthorized(e, ImmutableListMultimap.of("Foo", "Bar"), OPENLAYER_ERROR) })
    }
    ...
    fun dataStream403() {
      ...
      assertThatThrownBy({ client.inferencePipelines().data().stream(params) })
          .satisfies({ e -> assertPermissionDenied(e, ImmutableListMultimap.of("Foo", "Bar"), OPENLAYER_ERROR) })
    }
    ...
    fun dataStream404() {
      ...
      assertThatThrownBy({ client.inferencePipelines().data().stream(params) })
          .satisfies({ e -> assertNotFound(e, ImmutableListMultimap.of("Foo", "Bar"), OPENLAYER_ERROR) })
    }
    ...
    fun dataStream422() {
      ...
      assertThatThrownBy({ client.inferencePipelines().data().stream(params) })
          .satisfies({ e -> assertUnprocessableEntity(e, ImmutableListMultimap.of("Foo", "Bar"), OPENLAYER_ERROR) })
    }
    ...
    fun dataStream429() {
      ...
      assertThatThrownBy({ client.inferencePipelines().data().stream(params) })
          .satisfies({ e -> assertRateLimit(e, ImmutableListMultimap.of("Foo", "Bar"), OPENLAYER_ERROR) })
    }
    ...
    fun dataStream500() {
      ...
      assertThatThrownBy({ client.inferencePipelines().data().stream(params) })
          .satisfies({ e -> assertInternalServer(e, ImmutableListMultimap.of("Foo", "Bar"), OPENLAYER_ERROR) })
    }
    ...
    fun unexpectedStatusCode() {
      ...
      assertThatThrownBy({ client.inferencePipelines().data().stream(params) }).satisfies({ e -> assertUnexpectedStatusCodeException(e, 999, ImmutableListMultimap.of("Foo", "Bar"), toJson(OPENLAYER_ERROR)) })
    }
    ...
    fun invalidBody() {
      ...
      assertThatThrownBy({ client.inferencePipelines().data().stream(params) }).satisfies({ e -> assertThat(e)
    ...
    fun invalidErrorBody() {
      ...
      assertThatThrownBy({ client.inferencePipelines().data().stream(params) }).satisfies({ e -> assertBadRequest(e, ImmutableListMultimap.of(), OpenlayerError.builder().build()) })
    }
    ...
    private fun assertBadRequest(throwable: Throwable, headers: ListMultimap<String, String>, error: OpenlayerError) {
      assertThat(throwable)
    ...
    private fun assertUnauthorized(throwable: Throwable, headers: ListMultimap<String, String>, error: OpenlayerError) {
      assertThat(throwable)
    ...
    private fun assertPermissionDenied(throwable: Throwable, headers: ListMultimap<String, String>, error: OpenlayerError) {
      assertThat(throwable)
    ...
    private fun assertNotFound(throwable: Throwable, headers: ListMultimap<String, String>, error: OpenlayerError) {
      assertThat(throwable)
    ...
    private fun assertUnprocessableEntity(throwable: Throwable, headers: ListMultimap<String, String>, error: OpenlayerError) {
      assertThat(throwable)
    ...
    private fun assertRateLimit(throwable: Throwable, headers: ListMultimap<String, String>, error: OpenlayerError) {
      assertThat(throwable)
    ...
    private fun assertInternalServer(throwable: Throwable, headers: ListMultimap<String, String>, error: OpenlayerError) {
      assertThat(throwable)

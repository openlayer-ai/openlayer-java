    ...
    fun createProjectInferencePipelineCreateResponse() {
        val projectInferencePipelineCreateResponse =
            ProjectInferencePipelineCreateResponse.builder()
                ...
                .totalGoalCount(6L)
                .project(
                    ProjectInferencePipelineCreateResponse.Project.builder()
                        .id("3fa85f64-5717-4562-b3fc-2c963f66afa6")
                        ...
                        .links(
                            ProjectInferencePipelineCreateResponse.Project.Links.builder()
                                .app(
                        ...
                        .name("My Project")
                        .source(ProjectInferencePipelineCreateResponse.Project.Source.WEB)
                        .taskType(ProjectInferencePipelineCreateResponse.Project.TaskType.LLM_BASE)
                        .versionCount(2L)
                        .workspaceId("055fddb1-261f-4654-8598-f6347ee46a09")
                        .description("My project description.")
                        .gitRepo(
                            ProjectInferencePipelineCreateResponse.Project.GitRepo.builder()
                ...
                .workspace(
                    ProjectInferencePipelineCreateResponse.Workspace.builder()
                        .id("182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e")
                        ...
                        .projectCount(0L)
                        .slug("openlayer")
                        .status(ProjectInferencePipelineCreateResponse.Workspace.Status.ACTIVE)
                        .inviteCode("inviteCode")
                        .monthlyUsage(
                            listOf(
                                ProjectInferencePipelineCreateResponse.Workspace.MonthlyUsage
                                    .builder()
                                    .executionTimeMs(0L)
        ...
        assertThat(projectInferencePipelineCreateResponse.project())
            .contains(
                ProjectInferencePipelineCreateResponse.Project.builder()
                    .id("3fa85f64-5717-4562-b3fc-2c963f66afa6")
                    .creatorId("589ece63-49a2-41b4-98e1-10547761d4b0")
        ...
        assertThat(projectInferencePipelineCreateResponse.workspace())
            .contains(
                ProjectInferencePipelineCreateResponse.Workspace.builder()
                    .id("182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e")
                    .creatorId("182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e")
                    ...
                    .monthlyUsage(
                        listOf(
                            ProjectInferencePipelineCreateResponse.Workspace.MonthlyUsage.builder()
                                .executionTimeMs(0L)
                                .monthYear(LocalDate.parse("2019-12-27"))
                                .predictionCount(0L)
                                .build()
        ...
        assertThat(projectInferencePipelineCreateResponse.workspaceId())

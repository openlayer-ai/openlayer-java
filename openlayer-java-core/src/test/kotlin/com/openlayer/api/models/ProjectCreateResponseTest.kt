...
class ProjectCreateResponseTest {
    ...
    fun createProjectCreateResponse() {
      val projectCreateResponse = ProjectCreateResponse.builder()
          ...
          .links(ProjectCreateResponse.Links.builder()
          ...
          .gitRepo(ProjectCreateResponse.GitRepo.builder()
      ...
      assertThat(projectCreateResponse.creatorId()).contains("589ece63-49a2-41b4-98e1-10547761d4b0")
      assertThat(projectCreateResponse.dateCreated()).isEqualTo(OffsetDateTime.parse("2024-03-22T11:31:01.185Z"))
      assertThat(projectCreateResponse.dateUpdated()).isEqualTo(OffsetDateTime.parse("2024-03-22T11:31:01.185Z"))
      ...
      assertThat(projectCreateResponse.links()).isEqualTo(ProjectCreateResponse.Links.builder()
          .app("https://app.openlayer.com/myWorkspace/3fa85f64-5717-4562-b3fc-2c963f66afa6")
          .build())
      ...
      assertThat(projectCreateResponse.taskType()).isEqualTo(ProjectCreateResponse.TaskType.LLM_BASE)
      assertThat(projectCreateResponse.versionCount()).isEqualTo(123L)
      assertThat(projectCreateResponse.workspaceId()).contains("055fddb1-261f-4654-8598-f6347ee46a09")
      assertThat(projectCreateResponse.description()).contains("My project description.")
      assertThat(projectCreateResponse.gitRepo()).contains(ProjectCreateResponse.GitRepo.builder()
          .id("182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e")
          .dateConnected(OffsetDateTime.parse("2019-12-27T18:11:19.117Z"))
          .dateUpdated(OffsetDateTime.parse("2019-12-27T18:11:19.117Z"))
          .gitAccountId("182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e")

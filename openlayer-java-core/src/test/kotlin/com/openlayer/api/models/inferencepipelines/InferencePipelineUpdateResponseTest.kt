...
internal class InferencePipelineUpdateResponseTest {
    ...
    fun create() {
        val inferencePipelineUpdateResponse =
            InferencePipelineUpdateResponse.builder()
                ...
                .totalGoalCount(6L)
                .dataBackend(
                    InferencePipelineUpdateResponse.DataBackend.BigQueryDataBackend.builder()
                        .backendType(
                            InferencePipelineUpdateResponse.DataBackend.BigQueryDataBackend
                                .BackendType
                                .BIGQUERY
                        )
        ...
        assertThat(inferencePipelineUpdateResponse.status())
            .isEqualTo(InferencePipelineUpdateResponse.Status.COMPLETED)
        ...
        assertThat(inferencePipelineUpdateResponse.dataBackend())
            .contains(
                InferencePipelineUpdateResponse.DataBackend.ofBigQuery(
                    InferencePipelineUpdateResponse.DataBackend.BigQueryDataBackend.builder()
                        .backendType(
                            InferencePipelineUpdateResponse.DataBackend.BigQueryDataBackend
                                .BackendType
    ...
    fun roundtrip() {
        ...
        val roundtrippedInferencePipelineUpdateResponse =
            jsonMapper.readValue(
                jsonMapper.writeValueAsString(inferencePipelineUpdateResponse),
                jacksonTypeRef<InferencePipelineUpdateResponse>(),
            )

        assertThat(roundtrippedInferencePipelineUpdateResponse)
            .isEqualTo(inferencePipelineUpdateResponse)
    }
}

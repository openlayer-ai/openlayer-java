...
internal class InferencePipelineListResponseTest {
            ...
            InferencePipelineListResponse.builder()
                .addItem(
                    InferencePipelineListResponse.Item.builder()
                        ...
                        .failingGoalCount(1L)
                        .links(
                            InferencePipelineListResponse.Item.Links.builder()
                                .app(
                        ...
                        .project(
                            InferencePipelineListResponse.Item.Project.builder()
                                ...
                                .links(
                                    InferencePipelineListResponse.Item.Project.Links.builder()
                                        .app(
                                ...
                                .name("My Project")
                                .source(InferencePipelineListResponse.Item.Project.Source.WEB)
                                .taskType(
                                    InferencePipelineListResponse.Item.Project.TaskType.LLM_BASE
                                )
                                .versionCount(2L)
                                .workspaceId("055fddb1-261f-4654-8598-f6347ee46a09")
                                .description("My project description.")
                                .gitRepo(
                                    InferencePipelineListResponse.Item.Project.GitRepo.builder()
                ...
                InferencePipelineListResponse.Item.builder()
                    ...
                    .project(
                        InferencePipelineListResponse.Item.Project.builder()
                            ...
                            .name("My Project")
                            .source(InferencePipelineListResponse.Item.Project.Source.WEB)
                            .taskType(InferencePipelineListResponse.Item.Project.TaskType.LLM_BASE)
                            .versionCount(2L)
                            .workspaceId("055fddb1-261f-4654-8598-f6347ee46a09")
                            .description("My project description.")
                            .gitRepo(
    ...
    fun roundtrip() {
        ...
        val roundtrippedInferencePipelineListResponse =
            jsonMapper.readValue(
                jsonMapper.writeValueAsString(inferencePipelineListResponse),
                jacksonTypeRef<InferencePipelineListResponse>(),
            )

        assertThat(roundtrippedInferencePipelineListResponse)
            .isEqualTo(inferencePipelineListResponse)
    }
}

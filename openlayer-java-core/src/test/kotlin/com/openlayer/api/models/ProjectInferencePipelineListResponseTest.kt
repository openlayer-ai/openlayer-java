...
class ProjectInferencePipelineListResponseTest {
    ...
    fun createProjectInferencePipelineListResponse() {
      val projectInferencePipelineListResponse = ProjectInferencePipelineListResponse.builder()
          ._meta(ProjectInferencePipelineListResponse._Meta.builder()
              .page(123L)
              .perPage(100L)
              .totalItems(123L)
              .totalPages(123L)
              .build())
          .items(listOf(ProjectInferencePipelineListResponse.Item.builder()
              ...
              .links(ProjectInferencePipelineListResponse.Item.Links.builder()
      ...
      assertThat(projectInferencePipelineListResponse._meta()).isEqualTo(ProjectInferencePipelineListResponse._Meta.builder()
          .page(123L)
          .perPage(100L)
          .totalItems(123L)
          .totalPages(123L)
          .build())
      assertThat(projectInferencePipelineListResponse.items()).containsExactly(ProjectInferencePipelineListResponse.Item.builder()
          .id("3fa85f64-5717-4562-b3fc-2c963f66afa6")
          .dateCreated(OffsetDateTime.parse("2024-03-22T11:31:01.185Z"))
          .dateLastEvaluated(OffsetDateTime.parse("2024-03-22T11:31:01.185Z"))
          .dateLastSampleReceived(OffsetDateTime.parse("2024-03-22T11:31:01.185Z"))

...
class ProjectCommitCreateResponseTest {
    ...
    fun createProjectCommitCreateResponse() {
        ...
        assertThat(projectCommitCreateResponse.failingGoalCount()).isEqualTo(123L)
        assertThat(projectCommitCreateResponse.mlModelId())
            .contains("3fa85f64-5717-4562-b3fc-2c963f66afa6")
        assertThat(projectCommitCreateResponse.passingGoalCount()).isEqualTo(123L)
        ...
        assertThat(projectCommitCreateResponse.storageUri()).isEqualTo("s3://...")
        assertThat(projectCommitCreateResponse.totalGoalCount()).isEqualTo(123L)
        assertThat(projectCommitCreateResponse.trainingDatasetId())
            .contains("3fa85f64-5717-4562-b3fc-2c963f66afa6")
        assertThat(projectCommitCreateResponse.validationDatasetId())
            .contains("3fa85f64-5717-4562-b3fc-2c963f66afa6")
        assertThat(projectCommitCreateResponse.archived()).contains(true)

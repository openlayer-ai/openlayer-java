...
class ProjectListResponseTest {
    ...
    fun createProjectListResponse() {
      val projectListResponse = ProjectListResponse.builder()
          ._meta(ProjectListResponse._Meta.builder()
              .page(123L)
              .perPage(100L)
              .totalItems(123L)
              .totalPages(123L)
              .build())
          .items(listOf(ProjectListResponse.Item.builder()
              ...
              .links(ProjectListResponse.Item.Links.builder()
              ...
              .gitRepo(ProjectListResponse.Item.GitRepo.builder()
      ...
      assertThat(projectListResponse._meta()).isEqualTo(ProjectListResponse._Meta.builder()
          .page(123L)
          .perPage(100L)
          .totalItems(123L)
          .totalPages(123L)
          .build())
      assertThat(projectListResponse.items()).containsExactly(ProjectListResponse.Item.builder()
          .id("3fa85f64-5717-4562-b3fc-2c963f66afa6")
          .creatorId("589ece63-49a2-41b4-98e1-10547761d4b0")
          .dateCreated(OffsetDateTime.parse("2024-03-22T11:31:01.185Z"))
          .dateUpdated(OffsetDateTime.parse("2024-03-22T11:31:01.185Z"))

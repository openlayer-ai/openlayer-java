...
import com.openlayer.api.models.InferencePipelineRowUpdateParams.InferencePipelineRowUpdateBody
...
class InferencePipelineRowUpdateParamsTest {
    ...
    @Test
    fun getQueryParams() {
      val params = InferencePipelineRowUpdateParams.builder()
          .inferencePipelineId("182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e")
          .row(JsonValue.from(mapOf<String, Any>()))
          .config(InferencePipelineRowUpdateParams.Config.builder()
              .groundTruthColumnName("ground_truth")
    ...
    fun getBody() {
      ...
      assertThat(body.config()).isEqualTo(InferencePipelineRowUpdateParams.Config.builder()
          .groundTruthColumnName("ground_truth")
          .humanFeedbackColumnName("human_feedback")
          .inferenceIdColumnName("id")
          .latencyColumnName("latency")

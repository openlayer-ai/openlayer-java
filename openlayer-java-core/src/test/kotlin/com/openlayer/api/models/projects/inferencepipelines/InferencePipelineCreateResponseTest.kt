...
internal class InferencePipelineCreateResponseTest {
    ...
    fun create() {
        val inferencePipelineCreateResponse =
            InferencePipelineCreateResponse.builder()
                ...
                .failingGoalCount(1L)
                .links(
                    InferencePipelineCreateResponse.Links.builder()
                        .app(
                ...
                .status(InferencePipelineCreateResponse.Status.COMPLETED)
                ...
                .dataBackend(
                    InferencePipelineCreateResponse.DataBackend.BigQueryDataBackend.builder()
                        ...
                        .config(
                            InferencePipelineCreateResponse.DataBackend.BigQueryDataBackend.Config
                                .builder()
                ...
                .project(
                    InferencePipelineCreateResponse.Project.builder()
                        .id("3fa85f64-5717-4562-b3fc-2c963f66afa6")
                        ...
                        .links(
                            InferencePipelineCreateResponse.Project.Links.builder()
                                .app(
                        ...
                        .name("My Project")
                        .source(InferencePipelineCreateResponse.Project.Source.WEB)
                        .taskType(InferencePipelineCreateResponse.Project.TaskType.LLM_BASE)
                        .versionCount(2L)
                        .workspaceId("055fddb1-261f-4654-8598-f6347ee46a09")
                        .description("My project description.")
                        .gitRepo(
                            InferencePipelineCreateResponse.Project.GitRepo.builder()
                ...
                .workspace(
                    InferencePipelineCreateResponse.Workspace.builder()
                        .id("182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e")
                        ...
                        .projectCount(0L)
                        .slug("openlayer")
                        .status(InferencePipelineCreateResponse.Workspace.Status.ACTIVE)
                        .inviteCode("inviteCode")
                        .addMonthlyUsage(
                            InferencePipelineCreateResponse.Workspace.MonthlyUsage.builder()
                                .executionTimeMs(0L)
        ...
        assertThat(inferencePipelineCreateResponse.dateLastEvaluated())
            .contains(OffsetDateTime.parse("2024-03-22T11:31:01.185Z"))
        assertThat(inferencePipelineCreateResponse.dateLastSampleReceived())
            .contains(OffsetDateTime.parse("2024-03-22T11:31:01.185Z"))
        assertThat(inferencePipelineCreateResponse.dateOfNextEvaluation())
            .contains(OffsetDateTime.parse("2024-03-22T11:31:01.185Z"))
        assertThat(inferencePipelineCreateResponse.dateUpdated())
            .isEqualTo(OffsetDateTime.parse("2024-03-22T11:31:01.185Z"))
        assertThat(inferencePipelineCreateResponse.description())
            .contains("This pipeline is used for production.")
        assertThat(inferencePipelineCreateResponse.failingGoalCount()).isEqualTo(1L)
        assertThat(inferencePipelineCreateResponse.links())
            .isEqualTo(
                InferencePipelineCreateResponse.Links.builder()
                    .app(
                        "https://app.openlayer.com/myWorkspace/3fa85f64-5717-4562-b3fc-2c963f66afa6/inference-pipeline/3fa85f64-5717-4562-b3fc-2c963f66afa6"
        ...
        assertThat(inferencePipelineCreateResponse.name()).isEqualTo("production")
        assertThat(inferencePipelineCreateResponse.passingGoalCount()).isEqualTo(5L)
        assertThat(inferencePipelineCreateResponse.projectId())
            .isEqualTo("3fa85f64-5717-4562-b3fc-2c963f66afa6")
        assertThat(inferencePipelineCreateResponse.status())
            .isEqualTo(InferencePipelineCreateResponse.Status.COMPLETED)
        assertThat(inferencePipelineCreateResponse.statusMessage())
        ...
        assertThat(inferencePipelineCreateResponse.dateLastPolled())
            .contains(OffsetDateTime.parse("2019-12-27T18:11:19.117Z"))
        assertThat(inferencePipelineCreateResponse.project())
            .contains(
                InferencePipelineCreateResponse.Project.builder()
                    .id("3fa85f64-5717-4562-b3fc-2c963f66afa6")
                    .creatorId("589ece63-49a2-41b4-98e1-10547761d4b0")
        ...
        assertThat(inferencePipelineCreateResponse.totalRecordsCount()).contains(1000L)
        assertThat(inferencePipelineCreateResponse.workspace())
            .contains(
                InferencePipelineCreateResponse.Workspace.builder()
                    .id("182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e")
                    .creatorId("182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e")
        ...
        assertThat(inferencePipelineCreateResponse.workspaceId())
    ...
    fun roundtrip() {
        ...
        val roundtrippedInferencePipelineCreateResponse =
            jsonMapper.readValue(
                jsonMapper.writeValueAsString(inferencePipelineCreateResponse),
                jacksonTypeRef<InferencePipelineCreateResponse>(),
            )

        assertThat(roundtrippedInferencePipelineCreateResponse)
            .isEqualTo(inferencePipelineCreateResponse)
    }
}

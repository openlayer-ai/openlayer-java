...
import com.openlayer.api.client.okhttp.OkHttpClient
        ...
        val failingHttpClient =
            object : HttpClient {
                override fun execute(
                    ...
                    callCount++
                    if (callCount == 1) {
                        throw OpenlayerRetryableException("Simulated retryable failure")
                    }
                ...
                override fun executeAsync(
                    ...
                    if (callCount == 1) {
                        ...
                        future.completeExceptionally(
                            OpenlayerRetryableException("Simulated retryable failure")
                        )
                        return future
                    }

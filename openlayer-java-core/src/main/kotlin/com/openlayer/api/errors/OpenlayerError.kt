...
@NoAutoDetect
class OpenlayerError constructor(private val additionalProperties: Map<String, JsonValue>, ) {
    ...
    override fun equals(other: Any?): Boolean {
      ...
      return other is OpenlayerError &&
    ...
    class Builder {
        ...
        fun from(error: OpenlayerError) = apply {

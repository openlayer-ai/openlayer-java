...
private constructor(
    ...
    class Builder internal constructor() {
        ...
        internal fun from(commitCreateResponse: CommitCreateResponse) = apply {
            id = commitCreateResponse.id
            commit = commitCreateResponse.commit
            dateArchived = commitCreateResponse.dateArchived
            dateCreated = commitCreateResponse.dateCreated
            failingGoalCount = commitCreateResponse.failingGoalCount
            mlModelId = commitCreateResponse.mlModelId
            passingGoalCount = commitCreateResponse.passingGoalCount
            projectId = commitCreateResponse.projectId
            status = commitCreateResponse.status
            statusMessage = commitCreateResponse.statusMessage
            storageUri = commitCreateResponse.storageUri
            totalGoalCount = commitCreateResponse.totalGoalCount
            trainingDatasetId = commitCreateResponse.trainingDatasetId
            validationDatasetId = commitCreateResponse.validationDatasetId
            archived = commitCreateResponse.archived
            deploymentStatus = commitCreateResponse.deploymentStatus

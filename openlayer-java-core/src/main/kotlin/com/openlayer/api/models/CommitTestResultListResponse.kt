...
@NoAutoDetect
class CommitTestResultListResponse private constructor(private val _meta: JsonField<_Meta>, private val items: JsonField<List<Item>>, private val additionalProperties: Map<String, JsonValue>, ) {
    ...
    override fun toString() = "CommitTestResultListResponse{_meta=$_meta, items=$items, additionalProperties=$additionalProperties}"
    ...
    class Builder {
        ...
        fun build(): CommitTestResultListResponse = CommitTestResultListResponse(
            _meta,

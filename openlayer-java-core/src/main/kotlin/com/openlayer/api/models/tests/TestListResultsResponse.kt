...
class TestListResultsResponse
@JsonCreator(mode = JsonCreator.Mode.DISABLED)
private constructor(
    private val items: JsonField<List<Item>>,
    private val lastUnskippedResult: JsonField<LastUnskippedResult>,
    ...
    private constructor(
        ...
        @JsonProperty("lastUnskippedResult")
        @ExcludeMissing
        lastUnskippedResult: JsonField<LastUnskippedResult> = JsonMissing.of(),
    ) : this(items, lastUnskippedResult, mutableMapOf())
     ...
     */
    fun lastUnskippedResult(): Optional<LastUnskippedResult> =
        lastUnskippedResult.getOptional("lastUnskippedResult")
    ...
    /**
     * Returns the raw JSON value of [lastUnskippedResult].
     *
     * Unlike [lastUnskippedResult], this method doesn't throw if the JSON field has an unexpected
     * type.
     */
    @JsonProperty("lastUnskippedResult")
    @ExcludeMissing
    fun _lastUnskippedResult(): JsonField<LastUnskippedResult> = lastUnskippedResult
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [TestListResultsResponse].
         *
    ...
    /** A builder for [TestListResultsResponse]. */
    class Builder internal constructor() {

        private var items: JsonField<MutableList<Item>>? = null
        private var lastUnskippedResult: JsonField<LastUnskippedResult> = JsonMissing.of()
        private var additionalProperties: MutableMap<String, JsonValue> = mutableMapOf()

        @JvmSynthetic
        internal fun from(testListResultsResponse: TestListResultsResponse) = apply {
            items = testListResultsResponse.items.map { it.toMutableList() }
            lastUnskippedResult = testListResultsResponse.lastUnskippedResult
            additionalProperties = testListResultsResponse.additionalProperties.toMutableMap()
        }
        ...
        fun lastUnskippedResult(lastUnskippedResult: LastUnskippedResult?) =
            lastUnskippedResult(JsonField.ofNullable(lastUnskippedResult))

        /**
         * Alias for calling [Builder.lastUnskippedResult] with `lastUnskippedResult.orElse(null)`.
         */
        fun lastUnskippedResult(lastUnskippedResult: Optional<LastUnskippedResult>) =
            lastUnskippedResult(lastUnskippedResult.getOrNull())

        /**
         * Sets [Builder.lastUnskippedResult] to an arbitrary JSON value.
         *
         * You should usually call [Builder.lastUnskippedResult] with a well-typed
         * [LastUnskippedResult] value instead. This method is primarily for setting the field to an
         * undocumented or not yet supported value.
         */
        fun lastUnskippedResult(lastUnskippedResult: JsonField<LastUnskippedResult>) = apply {
            this.lastUnskippedResult = lastUnskippedResult
        }
        ...
        /**
         * Returns an immutable instance of [TestListResultsResponse].
         *
         ...
         */
        fun build(): TestListResultsResponse =
     ...
     *   expected type.
     */
    fun validate(): TestListResultsResponse = apply {
        if (validated) {
            return@apply
        }

        items().forEach { it.validate() }
        lastUnskippedResult().ifPresent { it.validate() }
        validated = true
    }
    ...
    internal fun validity(): Int =
        (items.asKnown().getOrNull()?.sumOf { it.validity().toInt() } ?: 0) +
            (lastUnskippedResult.asKnown().getOrNull()?.validity() ?: 0)
    ...
    private constructor(
        ...
        private constructor(
            ...
            private constructor(
                ...
                private constructor(
                     ...
                     * ```
                     *
                     * @throws OpenlayerInvalidDataException if [Visitor.unknown] is not overridden
        ...
        private constructor(
            ...
            private constructor(
                 ...
                 * import java.util.Optional;
                 *
                 * Optional<String> result = columnFilter.accept(new ColumnFilter.Visitor<Optional<String>>() {
                 *     @Override
                 *     public Optional<String> visitSet(SetColumnFilter set) {
                 *         return Optional.of(set.toString());
                 *     }
                 *
                 *     // ...
                 *
                ...
                private constructor(
                    ...
                    private constructor(
                         ...
                         * ```
                         *
                         * @throws OpenlayerInvalidDataException if [Visitor.unknown] is not
    ...
    private constructor(
        ...
        /** A builder for [LastUnskippedResult]. */
        class Builder internal constructor() {
            ...
            @JvmSynthetic
            internal fun from(lastUnskippedResult: LastUnskippedResult) = apply {
                id = lastUnskippedResult.id
                dateCreated = lastUnskippedResult.dateCreated
                dateDataEnds = lastUnskippedResult.dateDataEnds
                dateDataStarts = lastUnskippedResult.dateDataStarts
                dateUpdated = lastUnskippedResult.dateUpdated
                inferencePipelineId = lastUnskippedResult.inferencePipelineId
                projectVersionId = lastUnskippedResult.projectVersionId
                status = lastUnskippedResult.status
                statusMessage = lastUnskippedResult.statusMessage
                expectedValues = lastUnskippedResult.expectedValues.map { it.toMutableList() }
                goal = lastUnskippedResult.goal
                goalId = lastUnskippedResult.goalId
                rows = lastUnskippedResult.rows
                rowsBody = lastUnskippedResult.rowsBody
                additionalProperties = lastUnskippedResult.additionalProperties.toMutableMap()
            }
         ...
         *   expected type.
         */
        fun validate(): LastUnskippedResult = apply {
            if (validated) {
                return@apply
            }
        ...
        override fun equals(other: Any?): Boolean {
            ...
            return other is LastUnskippedResult &&
                id == other.id &&
                dateCreated == other.dateCreated &&
                dateDataEnds == other.dateDataEnds &&
                dateDataStarts == other.dateDataStarts &&
        ...
        override fun toString() =
            "LastUnskippedResult{id=$id, dateCreated=$dateCreated, dateDataEnds=$dateDataEnds, dateDataStarts=$dateDataStarts, dateUpdated=$dateUpdated, inferencePipelineId=$inferencePipelineId, projectVersionId=$projectVersionId, status=$status, statusMessage=$statusMessage, expectedValues=$expectedValues, goal=$goal, goalId=$goalId, rows=$rows, rowsBody=$rowsBody, additionalProperties=$additionalProperties}"
    }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is TestListResultsResponse &&
            items == other.items &&
            lastUnskippedResult == other.lastUnskippedResult &&
            additionalProperties == other.additionalProperties
    }

    private val hashCode: Int by lazy {
        Objects.hash(items, lastUnskippedResult, additionalProperties)
    }

    override fun hashCode(): Int = hashCode

    override fun toString() =
        "TestListResultsResponse{items=$items, lastUnskippedResult=$lastUnskippedResult, additionalProperties=$additionalProperties}"
}

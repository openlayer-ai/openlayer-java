...
private constructor(
    ...
    class Builder internal constructor() {
        ...
        internal fun from(inferencePipelineCreateResponse: InferencePipelineCreateResponse) =
            apply {
                ...
                dataBackend = inferencePipelineCreateResponse.dataBackend
                dateLastPolled = inferencePipelineCreateResponse.dateLastPolled
                project = inferencePipelineCreateResponse.project
                totalRecordsCount = inferencePipelineCreateResponse.totalRecordsCount
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is InferencePipelineCreateResponse &&
            id == other.id &&
            dateCreated == other.dateCreated &&

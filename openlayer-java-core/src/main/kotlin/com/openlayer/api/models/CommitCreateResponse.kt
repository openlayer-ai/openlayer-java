...
@JsonDeserialize(builder = CommitCreateResponse.Builder::class)
@NoAutoDetect
...
private constructor(
    ...
    class Builder {
        ...
        internal fun from(commitCreateResponse: CommitCreateResponse) = apply {
            this.id = commitCreateResponse.id
            this.dateCreated = commitCreateResponse.dateCreated
            this.status = commitCreateResponse.status
            this.statusMessage = commitCreateResponse.statusMessage
            this.projectId = commitCreateResponse.projectId
            this.storageUri = commitCreateResponse.storageUri
            this.commit = commitCreateResponse.commit
            this.deploymentStatus = commitCreateResponse.deploymentStatus
            this.mlModelId = commitCreateResponse.mlModelId
            this.validationDatasetId = commitCreateResponse.validationDatasetId
            this.trainingDatasetId = commitCreateResponse.trainingDatasetId
            this.archived = commitCreateResponse.archived
            this.dateArchived = commitCreateResponse.dateArchived
            this.passingGoalCount = commitCreateResponse.passingGoalCount
            this.failingGoalCount = commitCreateResponse.failingGoalCount
            this.totalGoalCount = commitCreateResponse.totalGoalCount
            this.links = commitCreateResponse.links
            additionalProperties(commitCreateResponse.additionalProperties)
        }

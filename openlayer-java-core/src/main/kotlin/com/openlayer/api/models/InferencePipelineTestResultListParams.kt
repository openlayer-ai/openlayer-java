...
class InferencePipelineTestResultListParams constructor(
  ...
  private val additionalBodyProperties: Map<String, JsonValue>,
    ...
    override fun toString() = "InferencePipelineTestResultListParams{inferencePipelineId=$inferencePipelineId, page=$page, perPage=$perPage, status=$status, type=$type, additionalQueryParams=$additionalQueryParams, additionalHeaders=$additionalHeaders, additionalBodyProperties=$additionalBodyProperties}"
    ...
    class Builder {
        ...
        @JvmSynthetic
        internal fun from(inferencePipelineTestResultListParams: InferencePipelineTestResultListParams) = apply {
        ...
        fun build(): InferencePipelineTestResultListParams = InferencePipelineTestResultListParams(

...
private constructor(
     ...
     */
    fun inviteCode(): Optional<String> = body.inviteCode()
     ...
     */
    fun _inviteCode(): JsonField<String> = body._inviteCode()
    ...
    class Builder internal constructor() {
         ...
         * value.
         */
        fun inviteCode(inviteCode: JsonField<String>) = apply { body.inviteCode(inviteCode) }

...
private constructor(
    ...
    class Builder internal constructor() {
        ...
        internal fun from(testResultListParams: TestResultListParams) = apply {
            projectVersionId = testResultListParams.projectVersionId
            includeArchived = testResultListParams.includeArchived
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return /* spotless:off */ other is TestResultListParams && projectVersionId == other.projectVersionId && includeArchived == other.includeArchived && page == other.page && perPage == other.perPage && status == other.status && type == other.type && additionalHeaders == other.additionalHeaders && additionalQueryParams == other.additionalQueryParams /* spotless:on */
    }
    ...
    override fun toString() =
        "TestResultListParams{projectVersionId=$projectVersionId, includeArchived=$includeArchived, page=$page, perPage=$perPage, status=$status, type=$type, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}

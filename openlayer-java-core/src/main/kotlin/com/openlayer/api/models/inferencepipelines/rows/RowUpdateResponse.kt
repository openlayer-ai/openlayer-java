...
private constructor(
    ...
    /** A builder for [RowUpdateResponse]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(rowUpdateResponse: RowUpdateResponse) = apply {
            success = rowUpdateResponse.success
            additionalProperties = rowUpdateResponse.additionalProperties.toMutableMap()
        }
        ...
        /**
         * Returns an immutable instance of [RowUpdateResponse].
         *
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return /* spotless:off */ other is RowUpdateResponse && success == other.success && additionalProperties == other.additionalProperties /* spotless:on */
    }
    ...
    override fun toString() =
        "RowUpdateResponse{success=$success, additionalProperties=$additionalProperties}"
}

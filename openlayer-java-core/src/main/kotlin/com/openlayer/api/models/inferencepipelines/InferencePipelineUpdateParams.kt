...
private constructor(
    ...
    companion object {
        ...
        @JvmStatic fun none(): InferencePipelineUpdateParams = builder().build()
    ...
    private constructor(
        ...
        private constructor(
            ...
            @ExcludeMissing
            referenceDatasetUri: JsonField<String> = JsonMissing.of(),
        ) : this(description, name, referenceDatasetUri, mutableMapOf())
        ...
        class Builder internal constructor() {
             ...
             */
            fun build(): Body =
                Body(description, name, referenceDatasetUri, additionalProperties.toMutableMap())
        }
        ...
        internal fun validity(): Int =
            (if (description.asKnown().isPresent) 1 else 0) +
                ...
                (if (referenceDatasetUri.asKnown().isPresent) 1 else 0)

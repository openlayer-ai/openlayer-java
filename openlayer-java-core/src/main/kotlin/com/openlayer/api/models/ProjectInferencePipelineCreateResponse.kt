...
private constructor(
    ...
    /** A builder for [ProjectInferencePipelineCreateResponse]. */
    class Builder internal constructor() {
        ...
        internal fun from(
            ...
            id = projectInferencePipelineCreateResponse.id
            dateCreated = projectInferencePipelineCreateResponse.dateCreated
            dateLastEvaluated = projectInferencePipelineCreateResponse.dateLastEvaluated
            dateLastSampleReceived = projectInferencePipelineCreateResponse.dateLastSampleReceived
            dateOfNextEvaluation = projectInferencePipelineCreateResponse.dateOfNextEvaluation
            dateUpdated = projectInferencePipelineCreateResponse.dateUpdated
            description = projectInferencePipelineCreateResponse.description
            failingGoalCount = projectInferencePipelineCreateResponse.failingGoalCount
            links = projectInferencePipelineCreateResponse.links
            name = projectInferencePipelineCreateResponse.name
            passingGoalCount = projectInferencePipelineCreateResponse.passingGoalCount
            projectId = projectInferencePipelineCreateResponse.projectId
            status = projectInferencePipelineCreateResponse.status
            statusMessage = projectInferencePipelineCreateResponse.statusMessage
            totalGoalCount = projectInferencePipelineCreateResponse.totalGoalCount
            project = projectInferencePipelineCreateResponse.project
            workspace = projectInferencePipelineCreateResponse.workspace
            workspaceId = projectInferencePipelineCreateResponse.workspaceId
            additionalProperties =
                projectInferencePipelineCreateResponse.additionalProperties.toMutableMap()
        }

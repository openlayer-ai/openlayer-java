...
private constructor(
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [InviteCreateResponse].
         *
    ...
    /** A builder for [InviteCreateResponse]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(inviteCreateResponse: InviteCreateResponse) = apply {
            items = inviteCreateResponse.items.map { it.toMutableList() }
            additionalProperties = inviteCreateResponse.additionalProperties.toMutableMap()
        }
        ...
        /**
         * Returns an immutable instance of [InviteCreateResponse].
         *
         ...
         */
        fun build(): InviteCreateResponse =
     ...
     *   expected type.
     */
    fun validate(): InviteCreateResponse = apply {
        if (validated) {
            return@apply
        }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is InviteCreateResponse &&
            items == other.items &&
            additionalProperties == other.additionalProperties
    }
    ...
    override fun toString() =
        "InviteCreateResponse{items=$items, additionalProperties=$additionalProperties}"
}

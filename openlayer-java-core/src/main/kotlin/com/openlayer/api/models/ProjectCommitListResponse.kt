...
@NoAutoDetect
class ProjectCommitListResponse private constructor(private val _meta: JsonField<_Meta>, private val items: JsonField<List<Item>>, private val additionalProperties: Map<String, JsonValue>, ) {
    ...
    override fun toString() = "ProjectCommitListResponse{_meta=$_meta, items=$items, additionalProperties=$additionalProperties}"
    ...
    class Builder {
        ...
        fun build(): ProjectCommitListResponse = ProjectCommitListResponse(
            _meta,
    ...
    class Item private constructor(
      ...
      private val additionalProperties: Map<String, JsonValue>,
        ...
        fun deploymentStatus(): Optional<String> = Optional.ofNullable(deploymentStatus.getNullable("deploymentStatus"))

        /** The model id. */
        fun mlModelId(): Optional<String> = Optional.ofNullable(mlModelId.getNullable("mlModelId"))

        /** The validation dataset id. */
        fun validationDatasetId(): Optional<String> = Optional.ofNullable(validationDatasetId.getNullable("validationDatasetId"))

        /** The training dataset id. */
        fun trainingDatasetId(): Optional<String> = Optional.ofNullable(trainingDatasetId.getNullable("trainingDatasetId"))
        ...
        @ExcludeMissing
        fun _deploymentStatus() = deploymentStatus

        /** The model id. */
        @JsonProperty("mlModelId")
        @ExcludeMissing
        fun _mlModelId() = mlModelId
        ...
        class Builder {
            ...
            @JsonProperty("commit")
            @ExcludeMissing
            fun commit(commit: JsonField<Commit>) = apply {
                this.commit = commit
            }

            /** The deployment status associated with the commit's model. */
            fun deploymentStatus(deploymentStatus: String) = deploymentStatus(JsonField.of(deploymentStatus))
            ...
            @JsonProperty("mlModelId")
            @ExcludeMissing
            fun mlModelId(mlModelId: JsonField<String>) = apply {
                this.mlModelId = mlModelId
            }

            /** The validation dataset id. */
            fun validationDatasetId(validationDatasetId: String) = validationDatasetId(JsonField.of(validationDatasetId))
            ...
            /** The training dataset id. */
            fun trainingDatasetId(trainingDatasetId: String) = trainingDatasetId(JsonField.of(trainingDatasetId))
        ...
        class Commit private constructor(
          ...
          private val additionalProperties: Map<String, JsonValue>,
            ...
            fun dateCreated(): Optional<OffsetDateTime> = Optional.ofNullable(dateCreated.getNullable("dateCreated"))
            ...
            fun gitCommitSha(): Optional<Long> = Optional.ofNullable(gitCommitSha.getNullable("gitCommitSha"))

            /** The ref of the corresponding git commit. */
            fun gitCommitRef(): Optional<String> = Optional.ofNullable(gitCommitRef.getNullable("gitCommitRef"))

            /** The URL of the corresponding git commit. */
            fun gitCommitUrl(): Optional<String> = Optional.ofNullable(gitCommitUrl.getNullable("gitCommitUrl"))
            ...
            @ExcludeMissing
            fun _gitCommitSha() = gitCommitSha

            /** The ref of the corresponding git commit. */
            @JsonProperty("gitCommitRef")
            @ExcludeMissing
            fun _gitCommitRef() = gitCommitRef

            /** The URL of the corresponding git commit. */
            @JsonProperty("gitCommitUrl")
            @ExcludeMissing
            fun _gitCommitUrl() = gitCommitUrl
            ...
            class Builder {
                ...
                @JsonProperty("authorId")
                @ExcludeMissing
                fun authorId(authorId: JsonField<String>) = apply {

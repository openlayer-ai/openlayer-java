...
class ProjectInferencePipelineListParams constructor(
  ...
  private val additionalBodyProperties: Map<String, JsonValue>,
    ...
    override fun toString() = "ProjectInferencePipelineListParams{projectId=$projectId, name=$name, page=$page, perPage=$perPage, additionalQueryParams=$additionalQueryParams, additionalHeaders=$additionalHeaders, additionalBodyProperties=$additionalBodyProperties}"
    ...
    class Builder {
        ...
        @JvmSynthetic
        internal fun from(projectInferencePipelineListParams: ProjectInferencePipelineListParams) = apply {
            ...
            additionalBodyProperties(projectInferencePipelineListParams.additionalBodyProperties)
        }
        ...
        fun build(): ProjectInferencePipelineListParams = ProjectInferencePipelineListParams(

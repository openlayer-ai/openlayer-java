...
private constructor(
     ...
     *   unexpectedly missing or null (e.g. if the server responded with an unexpected value).
     */
    fun commentCount(): Long = body.commentCount()
     ...
     *   server responded with an unexpected value).
     */
    fun originProjectVersionId(): Optional<String> = body.originProjectVersionId()
     ...
     *   unexpectedly missing or null (e.g. if the server responded with an unexpected value).
     */
    fun suggested(): Boolean = body.suggested()
     ...
     *   server responded with an unexpected value).
     */
    fun defaultToAllPipelines(): Optional<Boolean> = body.defaultToAllPipelines()
     ...
     *   server responded with an unexpected value).
     */
    fun delayWindow(): Optional<Double> = body.delayWindow()
     ...
     *   server responded with an unexpected value).
     */
    fun evaluationWindow(): Optional<Double> = body.evaluationWindow()
     ...
     *   server responded with an unexpected value).
     */
    fun excludePipelines(): Optional<List<String>> = body.excludePipelines()
     ...
     *   server responded with an unexpected value).
     */
    fun includeHistoricalData(): Optional<Boolean> = body.includeHistoricalData()
     ...
     *   server responded with an unexpected value).
     */
    fun includePipelines(): Optional<List<String>> = body.includePipelines()
     ...
     *   server responded with an unexpected value).
     */
    fun usesMlModel(): Optional<Boolean> = body.usesMlModel()
     ...
     *   server responded with an unexpected value).
     */
    fun usesProductionData(): Optional<Boolean> = body.usesProductionData()
     ...
     *   server responded with an unexpected value).
     */
    fun usesReferenceDataset(): Optional<Boolean> = body.usesReferenceDataset()
     ...
     *   server responded with an unexpected value).
     */
    fun usesTrainingDataset(): Optional<Boolean> = body.usesTrainingDataset()
     ...
     *   server responded with an unexpected value).
     */
    fun usesValidationDataset(): Optional<Boolean> = body.usesValidationDataset()
     ...
     */
    fun _commentCount(): JsonField<Long> = body._commentCount()
     ...
     */
    fun _number(): JsonField<Long> = body._number()
     ...
     * unexpected type.
     */
    fun _originProjectVersionId(): JsonField<String> = body._originProjectVersionId()
     ...
     */
    fun _suggested(): JsonField<Boolean> = body._suggested()
     ...
     * type.
     */
    fun _defaultToAllPipelines(): JsonField<Boolean> = body._defaultToAllPipelines()
     ...
     */
    fun _delayWindow(): JsonField<Double> = body._delayWindow()
     ...
     * type.
     */
    fun _evaluationWindow(): JsonField<Double> = body._evaluationWindow()
     ...
     * type.
     */
    fun _excludePipelines(): JsonField<List<String>> = body._excludePipelines()
     ...
     * type.
     */
    fun _includeHistoricalData(): JsonField<Boolean> = body._includeHistoricalData()
     ...
     * type.
     */
    fun _includePipelines(): JsonField<List<String>> = body._includePipelines()
     ...
     */
    fun _usesMlModel(): JsonField<Boolean> = body._usesMlModel()
     ...
     * type.
     */
    fun _usesProductionData(): JsonField<Boolean> = body._usesProductionData()
     ...
     * type.
     */
    fun _usesReferenceDataset(): JsonField<Boolean> = body._usesReferenceDataset()
     ...
     * type.
     */
    fun _usesTrainingDataset(): JsonField<Boolean> = body._usesTrainingDataset()
     ...
     * type.
     */
    fun _usesValidationDataset(): JsonField<Boolean> = body._usesValidationDataset()
    ...
    class Builder internal constructor() {
        ...
        internal fun from(testCreateParams: TestCreateParams) = apply {
            projectId = testCreateParams.projectId
        ...
        /** The number of comments on the test. */
        fun commentCount(commentCount: Long) = apply { body.commentCount(commentCount) }
         ...
         * value.
         */
        fun commentCount(commentCount: JsonField<Long>) = apply { body.commentCount(commentCount) }
        ...
        /** The test description. */
        fun description(description: JsonValue) = apply { body.description(description) }
        ...
        /** The test number. */
        fun number(number: Long) = apply { body.number(number) }
         ...
         * method is primarily for setting the field to an undocumented or not yet supported value.
         */
        fun number(number: JsonField<Long>) = apply { body.number(number) }

        /** The project version (commit) id where the test was created. */
        fun originProjectVersionId(originProjectVersionId: String?) = apply {
            body.originProjectVersionId(originProjectVersionId)
        }
         ...
         * value.
         */
        fun suggested(suggested: JsonField<Boolean>) = apply { body.suggested(suggested) }
         ...
         */
        fun defaultToAllPipelines(defaultToAllPipelines: Boolean?) = apply {
            body.defaultToAllPipelines(defaultToAllPipelines)
        }
        ...
        /** The delay window in seconds. Only applies to tests that use production data. */
        fun delayWindow(delayWindow: Double?) = apply { body.delayWindow(delayWindow) }
         ...
         * value.
         */
        fun delayWindow(delayWindow: JsonField<Double>) = apply { body.delayWindow(delayWindow) }

        /** The evaluation window in seconds. Only applies to tests that use production data. */
        fun evaluationWindow(evaluationWindow: Double?) = apply {
            body.evaluationWindow(evaluationWindow)
        }
         ...
         */
        fun excludePipelines(excludePipelines: List<String>?) = apply {
            body.excludePipelines(excludePipelines)
        }
        ...
        fun addExcludePipeline(excludePipeline: String) = apply {
            body.addExcludePipeline(excludePipeline)
        }
         ...
         * production data.
         */
        fun includeHistoricalData(includeHistoricalData: Boolean?) = apply {
            body.includeHistoricalData(includeHistoricalData)
        }
         ...
         * tests that use production data.
         */
        fun includePipelines(includePipelines: List<String>?) = apply {
            body.includePipelines(includePipelines)
        }
        ...
        fun addIncludePipeline(includePipeline: String) = apply {
            body.addIncludePipeline(includePipeline)
        }

        /** Whether the test uses an ML model. */
        fun usesMlModel(usesMlModel: Boolean) = apply { body.usesMlModel(usesMlModel) }
         ...
         * value.
         */
        fun usesMlModel(usesMlModel: JsonField<Boolean>) = apply { body.usesMlModel(usesMlModel) }

        /** Whether the test uses production data (monitoring mode only). */
        fun usesProductionData(usesProductionData: Boolean) = apply {
            body.usesProductionData(usesProductionData)
        }
        ...
        /** Whether the test uses a reference dataset (monitoring mode only). */
        fun usesReferenceDataset(usesReferenceDataset: Boolean) = apply {
            body.usesReferenceDataset(usesReferenceDataset)
        }
        ...
        /** Whether the test uses a training dataset. */
        fun usesTrainingDataset(usesTrainingDataset: Boolean) = apply {
            body.usesTrainingDataset(usesTrainingDataset)
        }
        ...
        /** Whether the test uses a validation dataset. */
        fun usesValidationDataset(usesValidationDataset: Boolean) = apply {
            body.usesValidationDataset(usesValidationDataset)
        }
    ...
    private constructor(
         ...
         * Returns the raw JSON value of [defaultToAllPipelines].
         *
         * Unlike [defaultToAllPipelines], this method doesn't throw if the JSON field has an
         * unexpected type.
         */
        @JsonProperty("defaultToAllPipelines")
        @ExcludeMissing
         ...
         * Returns the raw JSON value of [includeHistoricalData].
         *
         * Unlike [includeHistoricalData], this method doesn't throw if the JSON field has an
         * unexpected type.
         */
        @JsonProperty("includeHistoricalData")
        @ExcludeMissing
        ...
        class Builder internal constructor() {
            ...
            internal fun from(body: Body) = apply {
                ...
                name = body.name
                number = body.number
                originProjectVersionId = body.originProjectVersionId
                subtype = body.subtype
                suggested = body.suggested
                thresholds = body.thresholds.map { it.toMutableList() }
                type = body.type
                archived = body.archived
                defaultToAllPipelines = body.defaultToAllPipelines
                delayWindow = body.delayWindow
                evaluationWindow = body.evaluationWindow
                excludePipelines = body.excludePipelines.map { it.toMutableList() }
                includeHistoricalData = body.includeHistoricalData
                includePipelines = body.includePipelines.map { it.toMutableList() }
                usesMlModel = body.usesMlModel
                usesProductionData = body.usesProductionData
                usesReferenceDataset = body.usesReferenceDataset
                usesTrainingDataset = body.usesTrainingDataset
                usesValidationDataset = body.usesValidationDataset
             ...
             * Sets [Builder.originProjectVersionId] to an arbitrary JSON value.
             *
             * You should usually call [Builder.originProjectVersionId] with a well-typed [String]
             * value instead. This method is primarily for setting the field to an undocumented or
             * not yet supported value.
             */
            fun originProjectVersionId(originProjectVersionId: JsonField<String>) = apply {
             ...
             * Sets [Builder.defaultToAllPipelines] to an arbitrary JSON value.
             *
             * You should usually call [Builder.defaultToAllPipelines] with a well-typed [Boolean]
             * value instead. This method is primarily for setting the field to an undocumented or
             * not yet supported value.
             */
            fun defaultToAllPipelines(defaultToAllPipelines: JsonField<Boolean>) = apply {
             ...
             * Sets [Builder.excludePipelines] to an arbitrary JSON value.
             *
             * You should usually call [Builder.excludePipelines] with a well-typed `List<String>`
             * value instead. This method is primarily for setting the field to an undocumented or
             * not yet supported value.
             */
            fun excludePipelines(excludePipelines: JsonField<List<String>>) = apply {
             ...
             * Sets [Builder.includeHistoricalData] to an arbitrary JSON value.
             *
             * You should usually call [Builder.includeHistoricalData] with a well-typed [Boolean]
             * value instead. This method is primarily for setting the field to an undocumented or
             * not yet supported value.
             */
            fun includeHistoricalData(includeHistoricalData: JsonField<Boolean>) = apply {
            ...
            /**
             * Array of pipelines (data sources) to which the test should be applied. Only applies
             * to tests that use production data.
             */
             ...
             * Sets [Builder.includePipelines] to an arbitrary JSON value.
             *
             * You should usually call [Builder.includePipelines] with a well-typed `List<String>`
             * value instead. This method is primarily for setting the field to an undocumented or
             * not yet supported value.
             */
            fun includePipelines(includePipelines: JsonField<List<String>>) = apply {
             ...
             * Sets [Builder.usesReferenceDataset] to an arbitrary JSON value.
             *
             * You should usually call [Builder.usesReferenceDataset] with a well-typed [Boolean]
             * value instead. This method is primarily for setting the field to an undocumented or
             * not yet supported value.
             */
            fun usesReferenceDataset(usesReferenceDataset: JsonField<Boolean>) = apply {
             ...
             * Sets [Builder.usesValidationDataset] to an arbitrary JSON value.
             *
             * You should usually call [Builder.usesValidationDataset] with a well-typed [Boolean]
             * value instead. This method is primarily for setting the field to an undocumented or
             * not yet supported value.
             */
            fun usesValidationDataset(usesValidationDataset: JsonField<Boolean>) = apply {
    ...
    override fun toString() =
        "TestCreateParams{projectId=$projectId, body=$body, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}

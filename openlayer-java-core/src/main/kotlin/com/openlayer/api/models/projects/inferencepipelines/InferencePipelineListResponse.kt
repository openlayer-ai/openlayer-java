...
private constructor(
    ...
    /** A builder for [InferencePipelineListResponse]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(inferencePipelineListResponse: InferencePipelineListResponse) = apply {
            items = inferencePipelineListResponse.items.map { it.toMutableList() }
            additionalProperties = inferencePipelineListResponse.additionalProperties.toMutableMap()
        }
        ...
        /**
         * Returns an immutable instance of [InferencePipelineListResponse].
         *
         ...
         */
        fun build(): InferencePipelineListResponse =
            InferencePipelineListResponse(
     ...
     *   expected type.
     */
    fun validate(): InferencePipelineListResponse = apply {
        if (validated) {
            return@apply
        }
    ...
    private constructor(
        ...
        class Builder internal constructor() {
            ...
            internal fun from(item: Item) = apply {
                ...
                dataBackend = item.dataBackend
                dateLastPolled = item.dateLastPolled
        ...
        private constructor(
             ...
             * import java.util.Optional;
             *
             * Optional<String> result = dataBackend.accept(new DataBackend.Visitor<Optional<String>>() {
             *     @Override
             *     public Optional<String> visitBigQuery(BigQueryDataBackend bigQuery) {
             *         return Optional.of(bigQuery.toString());
             *     }
             *
             *     // ...
             *
             ...
             * ```
             *
             * @throws OpenlayerInvalidDataException if [Visitor.unknown] is not overridden in
            ...
            interface Visitor<out T> {
                 ...
                 *
                 * An instance of [DataBackend] can contain an unknown variant if it was
            ...
            private constructor(
                 ...
                 *
                 * Unlike [backendType], this method doesn't throw if the JSON field has an
                 * unexpected type.
                 */
                @JsonProperty("backendType")
                @ExcludeMissing
                 ...
                 *
                 * Unlike [tableId], this method doesn't throw if the JSON field has an unexpected
                 * type.
                 */
                 ...
                 *
                 * Unlike [partitionType], this method doesn't throw if the JSON field has an
                 * unexpected type.
                 */
                @JsonProperty("partitionType")
                @ExcludeMissing
                ...
                class Builder internal constructor() {
                     ...
                     *
                     * You should usually call [Builder.bigqueryConnectionId] with a well-typed
                     ...
                     *
                     * You should usually call [Builder.partitionType] with a well-typed
                     * [PartitionType] value instead. This method is primarily for setting the field
                ...
                private constructor(
                     ...
                     *
                     * Unlike [groundTruthColumnName], this method doesn't throw if the JSON field
                     ...
                     *
                     * Unlike [humanFeedbackColumnName], this method doesn't throw if the JSON field
                     * has an unexpected type.
                     */
                    @JsonProperty("humanFeedbackColumnName")
                    @ExcludeMissing
                     ...
                     *
                     * Unlike [inferenceIdColumnName], this method doesn't throw if the JSON field
                     * has an unexpected type.
                     */
                    @JsonProperty("inferenceIdColumnName")
                    @ExcludeMissing
                     ...
                     *
                     * Unlike [latencyColumnName], this method doesn't throw if the JSON field has
                     * an unexpected type.
                     */
                    @JsonProperty("latencyColumnName")
                    @ExcludeMissing
                     ...
                     *
                     * Unlike [timestampColumnName], this method doesn't throw if the JSON field has
                     * an unexpected type.
                     */
                    @JsonProperty("timestampColumnName")
                    @ExcludeMissing
                    ...
                    class Builder internal constructor() {
                         ...
                         */
                        fun groundTruthColumnName(groundTruthColumnName: JsonField<String>) =
                            apply {
                         ...
                         *
                         * You should usually call [Builder.humanFeedbackColumnName] with a
                         ...
                         * an undocumented or not yet supported value.
                         */
                        fun inferenceIdColumnName(inferenceIdColumnName: JsonField<String>) =
                            apply {
                ...
                private constructor(private val value: JsonField<String>) : Enum {
                     ...
                     * member.
                     *
                     * An instance of [PartitionType] can contain an unknown value in a couple of
                     * cases:
                     * - It was deserialized from data that doesn't match any known member. For
                     *   example, if the SDK is on an older version than the API, then the API may
                     *   respond with new members that the SDK is unaware of.
                    ...
                    fun known(): Known =
                        when (this) {
                            ...
                            YEAR -> Known.YEAR
                                ...
                                throw OpenlayerInvalidDataException("Unknown PartitionType: $value")
                        }
            ...
            private constructor(
                ...
                private val hashCode: Int by lazy {
                    Objects.hash(backendType, additionalProperties)
                }
            ...
            private constructor(
                ...
                private constructor(
                    ...
                    @JsonProperty("table")
                    @ExcludeMissing
                    table: JsonField<String> = JsonMissing.of(),
                ) : this(
                    backendType,
                    config,
                    database,
                ...
                @JsonProperty("database")
                @ExcludeMissing
                fun _database(): JsonField<String> = database
                 ...
                 *
                 * Unlike [snowflakeConnectionId], this method doesn't throw if the JSON field has
                 * an unexpected type.
                 */
                @JsonProperty("snowflakeConnectionId")
                @ExcludeMissing
                 ...
                 *
                 * Unlike [table], this method doesn't throw if the JSON field has an unexpected
                 * type.
                 */
                ...
                class Builder internal constructor() {
                     ...
                     *
                     * You should usually call [Builder.table] with a well-typed [String] value
                     * instead. This method is primarily for setting the field to an undocumented or
                     * not yet supported value.
                     */
            ...
            private constructor(
                 ...
                 *
                 * Unlike [databricksDtlConnectionId], this method doesn't throw if the JSON field
                 * has an unexpected type.
                 */
                @JsonProperty("databricksDtlConnectionId")
                @ExcludeMissing
            ...
            private constructor(
                 ...
                 *
                 * Unlike [schemaName], this method doesn't throw if the JSON field has an
                 * unexpected type.
                 */
                @JsonProperty("schemaName")
                @ExcludeMissing
                ...
                class Builder internal constructor() {
                     ...
                     *
                     * You should usually call [Builder.redshiftConnectionId] with a well-typed
                     * [String] value instead. This method is primarily for setting the field to an
                     * undocumented or not yet supported value.
                     */
                     ...
                     * not yet supported value.
                     */
                    fun tableName(tableName: JsonField<String>) = apply {
            ...
            private constructor(
                ...
                class Builder internal constructor() {
                     ...
                     *
                     * You should usually call [Builder.postgresConnectionId] with a well-typed
                     * [String] value instead. This method is primarily for setting the field to an
                     * undocumented or not yet supported value.
                     */
        ...
        private constructor(
            ...
            private constructor(
                ...
                @ExcludeMissing
                gitRepo: JsonField<GitRepo> = JsonMissing.of(),
             ...
             *   if the server responded with an unexpected value).
             */
            fun dataRetentionDays(): Optional<Long> =
                dataRetentionDays.getOptional("dataRetentionDays")
             ...
             *
             * Unlike [goalCount], this method doesn't throw if the JSON field has an unexpected
             * type.
             */
             ...
             *
             * Unlike [dataRetentionDays], this method doesn't throw if the JSON field has an
             * unexpected type.
             */
            @JsonProperty("dataRetentionDays")
            @ExcludeMissing
             ...
             *
             * Unlike [modelDeveloper], this method doesn't throw if the JSON field has an
             * unexpected type.
             */
            @JsonProperty("modelDeveloper")
            @ExcludeMissing
             ...
             *
             * Unlike [modelTypes], this method doesn't throw if the JSON field has an unexpected
             * type.
             */
            @JsonProperty("modelTypes")
            @ExcludeMissing
            ...
            class Builder internal constructor() {
                 ...
                 *
                 * You should usually call [Builder.developmentGoalCount] with a well-typed [Long]
                 * value instead. This method is primarily for setting the field to an undocumented
                 * or not yet supported value.
                 */
                 ...
                 *
                 * You should usually call [Builder.goalCount] with a well-typed [Long] value
                 * instead. This method is primarily for setting the field to an undocumented or not
                 * yet supported value.
                 */
                 ...
                 * Sets [Builder.links] to an arbitrary JSON value.
                 *
                 * You should usually call [Builder.links] with a well-typed [Links] value instead.
                 * This method is primarily for setting the field to an undocumented or not yet
                 * supported value.
                 */
                fun links(links: JsonField<Links>) = apply { this.links = links }
                 ...
                 *
                 * You should usually call [Builder.monitoringGoalCount] with a well-typed [Long]
                 * value instead. This method is primarily for setting the field to an undocumented
                 * or not yet supported value.
                 */
                ...
                /**
                 * Alias for calling [Builder.dataRetentionDays] with
                 * `dataRetentionDays.orElse(null)`.
                 */
                 ...
                 *
                 * You should usually call [Builder.dataRetentionDays] with a well-typed [Long]
                 * value instead. This method is primarily for setting the field to an undocumented
                 * or not yet supported value.
                 */
                 ...
                 *
                 * You should usually call [Builder.gitRepo] with a well-typed [GitRepo] value
                 * instead. This method is primarily for setting the field to an undocumented or not
                 * yet supported value.
                 */
                ...
                /** The kinds of model used in this project. */
                fun modelTypes(modelTypes: List<String>?) =
                    modelTypes(JsonField.ofNullable(modelTypes))

                /** Alias for calling [Builder.modelTypes] with `modelTypes.orElse(null)`. */
                fun modelTypes(modelTypes: Optional<List<String>>) =
                    modelTypes(modelTypes.getOrNull())

                /**
                 * Sets [Builder.modelTypes] to an arbitrary JSON value.
                 *
                 * You should usually call [Builder.modelTypes] with a well-typed `List<String>`
                 * value instead. This method is primarily for setting the field to an undocumented
                 * or not yet supported value.
                 */
            ...
            private constructor(
                ...
                class Builder internal constructor() {
                     ...
                     * Sets [Builder.app] to an arbitrary JSON value.
                     *
                     * You should usually call [Builder.app] with a well-typed [String] value
                     * instead. This method is primarily for setting the field to an undocumented or
                     * not yet supported value.
                     */
                    fun app(app: JsonField<String>) = apply { this.app = app }
            ...
            private constructor(
                ...
                private constructor(
                    ...
                    @JsonProperty("gitId")
                    @ExcludeMissing
                    gitId: JsonField<Long> = JsonMissing.of(),
                    @JsonProperty("name")
                    @ExcludeMissing
                 ...
                 *
                 * Unlike [dateConnected], this method doesn't throw if the JSON field has an
                 * unexpected type.
                 */
                @JsonProperty("dateConnected")
                @ExcludeMissing
                 ...
                 *
                 * Unlike [gitAccountId], this method doesn't throw if the JSON field has an
                 * unexpected type.
                 */
                @JsonProperty("gitAccountId")
                @ExcludeMissing
                 ...
                 *
                 * Unlike [gitId], this method doesn't throw if the JSON field has an unexpected
                 * type.
                 */
                 ...
                 *
                 * Unlike [branch], this method doesn't throw if the JSON field has an unexpected
                 * type.
                 */
                 ...
                 *
                 * Unlike [rootDir], this method doesn't throw if the JSON field has an unexpected
                 * type.
                 */
                ...
                class Builder internal constructor() {
                     ...
                     *
                     * You should usually call [Builder.gitAccountId] with a well-typed [String]
                     * value instead. This method is primarily for setting the field to an
                     * undocumented or not yet supported value.
                     */
                     ...
                     *
                     * You should usually call [Builder.gitId] with a well-typed [Long] value
                     * instead. This method is primarily for setting the field to an undocumented or
                     * not yet supported value.
                     */
        ...
        private constructor(
            ...
            fun periodEndDate(): Optional<OffsetDateTime> =
                periodEndDate.getOptional("periodEndDate")
            ...
            fun monthlyUsage(): Optional<List<MonthlyUsage>> =
                monthlyUsage.getOptional("monthlyUsage")
             ...
             *
             * Unlike [inviteCount], this method doesn't throw if the JSON field has an unexpected
             * type.
             */
            @JsonProperty("inviteCount")
            @ExcludeMissing
             ...
             *
             * Unlike [periodStartDate], this method doesn't throw if the JSON field has an
             * unexpected type.
             */
            @JsonProperty("periodStartDate")
            @ExcludeMissing
             ...
             *
             * Unlike [inviteCode], this method doesn't throw if the JSON field has an unexpected
             * type.
             */
            @JsonProperty("inviteCode")
            @ExcludeMissing
             ...
             *
             * Unlike [samlOnlyAccess], this method doesn't throw if the JSON field has an
             * unexpected type.
             */
            @JsonProperty("samlOnlyAccess")
            @ExcludeMissing
             ...
             *
             * Unlike [wildcardDomains], this method doesn't throw if the JSON field has an
             * unexpected type.
             */
            @JsonProperty("wildcardDomains")
            @ExcludeMissing
            ...
            class Builder internal constructor() {
                 ...
                 *
                 * You should usually call [Builder.inviteCount] with a well-typed [Long] value
                 * instead. This method is primarily for setting the field to an undocumented or not
                 * yet supported value.
                 */
                 ...
                 *
                 * You should usually call [Builder.periodEndDate] with a well-typed
                 ...
                 *
                 * You should usually call [Builder.periodStartDate] with a well-typed
                 * [OffsetDateTime] value instead. This method is primarily for setting the field to
                 * an undocumented or not yet supported value.
                 */
                 ...
                 * `List<MonthlyUsage>` value instead. This method is primarily for setting the
                 * field to an undocumented or not yet supported value.
                 */
                 ...
                 *
                 * You should usually call [Builder.samlOnlyAccess] with a well-typed [Boolean]
                 * value instead. This method is primarily for setting the field to an undocumented
                 * or not yet supported value.
                 */
            ...
            private constructor(
                ...
                fun executionTimeMs(): Optional<Long> =
                    executionTimeMs.getOptional("executionTimeMs")
                ...
                fun predictionCount(): Optional<Long> =
                    predictionCount.getOptional("predictionCount")
                ...
                class Builder internal constructor() {
                     ...
                     *
                     * You should usually call [Builder.executionTimeMs] with a well-typed [Long]
                     * value instead. This method is primarily for setting the field to an
                     * undocumented or not yet supported value.
                     */
                     ...
                     *
                     * You should usually call [Builder.monthYear] with a well-typed [LocalDate]
                     * value instead. This method is primarily for setting the field to an
                     * undocumented or not yet supported value.
                     */
                     ...
                     *
                     * You should usually call [Builder.predictionCount] with a well-typed [Long]
                     * value instead. This method is primarily for setting the field to an
                     * undocumented or not yet supported value.
                     */
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is InferencePipelineListResponse &&
            items == other.items &&
            additionalProperties == other.additionalProperties
    }
    ...
    override fun toString() =
        "InferencePipelineListResponse{items=$items, additionalProperties=$additionalProperties}"
}

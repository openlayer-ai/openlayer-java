...
private constructor(
    ...
    class Builder internal constructor() {
        ...
        internal fun from(commitListResponse: CommitListResponse) = apply {
            items = commitListResponse.items.map { it.toMutableList() }
    ...
    private constructor(
        ...
        private constructor(
             ...
             *
             * Unlike [authorId], this method doesn't throw if the JSON field has an unexpected
             * type.
             */
             ...
             * Returns the raw JSON value of [mlModelId].
             *
             * Unlike [mlModelId], this method doesn't throw if the JSON field has an unexpected
             * type.
             */
            @JsonProperty("mlModelId")
            @ExcludeMissing
             ...
             * Returns the raw JSON value of [storageUri].
             *
             * Unlike [storageUri], this method doesn't throw if the JSON field has an unexpected
             * type.
             */
            @JsonProperty("storageUri")
            @ExcludeMissing
             ...
             * Returns the raw JSON value of [trainingDatasetId].
             *
             * Unlike [trainingDatasetId], this method doesn't throw if the JSON field has an
             * unexpected type.
             */
            @JsonProperty("trainingDatasetId")
            @ExcludeMissing
            ...
            class Builder internal constructor() {
                 ...
                 *
                 * You should usually call [Builder.authorId] with a well-typed [String] value
                 ...
                 * Sets [Builder.mlModelId] to an arbitrary JSON value.
                 *
                 * You should usually call [Builder.mlModelId] with a well-typed [String] value
                 * instead. This method is primarily for setting the field to an undocumented or not
                 * yet supported value.
                 */
                fun mlModelId(mlModelId: JsonField<String>) = apply { this.mlModelId = mlModelId }
                 ...
                 * Sets [Builder.trainingDatasetId] to an arbitrary JSON value.
                 *
                 * You should usually call [Builder.trainingDatasetId] with a well-typed [String]
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return /* spotless:off */ other is CommitListResponse && items == other.items && additionalProperties == other.additionalProperties /* spotless:on */
    }
    ...
    override fun toString() =
        "CommitListResponse{items=$items, additionalProperties=$additionalProperties}"
}

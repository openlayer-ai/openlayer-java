...
class PresignedUrlServiceImpl constructor(private val clientOptions: ClientOptions, ) : PresignedUrlService {
    ...
    override fun create(params: StoragePresignedUrlCreateParams, requestOptions: RequestOptions): StoragePresignedUrlCreateResponse {

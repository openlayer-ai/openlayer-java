...
class InferencePipelineServiceImpl constructor(private val clientOptions: ClientOptions, ) : InferencePipelineService {
    ...
    override fun create(params: ProjectInferencePipelineCreateParams, requestOptions: RequestOptions): ProjectInferencePipelineCreateResponse {
    ...
    override fun list(params: ProjectInferencePipelineListParams, requestOptions: RequestOptions): ProjectInferencePipelineListResponse {
      val request = HttpRequest.builder()

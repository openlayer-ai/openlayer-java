...
interface RowServiceAsync {
    ...
    @JvmOverloads
    fun update(params: InferencePipelineRowUpdateParams, requestOptions: RequestOptions = RequestOptions.none()): CompletableFuture<InferencePipelineRowUpdateResponse>
}

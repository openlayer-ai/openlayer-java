...
interface TestResultServiceAsync {
    ...
    @JvmOverloads
    fun list(params: InferencePipelineTestResultListParams, requestOptions: RequestOptions = RequestOptions.none()): CompletableFuture<InferencePipelineTestResultListResponse>
}

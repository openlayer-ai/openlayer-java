...
-keep @com.fasterxml.jackson.databind.annotation.JsonSerialize class com.openlayer.api.** { *; }
-keep @com.fasterxml.jackson.databind.annotation.JsonDeserialize class com.openlayer.api.** { *; }

# Jackson uses reflection to serialize and deserialize our classes based on their constructors and annotated members.
-keepclassmembers class com.openlayer.api.** {
    <init>(...);
